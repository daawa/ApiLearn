...
//            case TOUCH_MODE_OVERSCROLL:
    ...
    private boolean moveTheChildren(int deltaY, int incrementalDeltaY) {
        ...
        if (DBG) {
            Log.d(TAG, "moveTheChildren " +
                    " firstTop " + highestChildTop +
                    " maxTop " + maxTop +
                    " incrementalDeltaY " + incrementalDeltaY);
            Log.d(TAG, "moveTheChildren " +
                    " lastBottom " + lowestChildBottom +
                    " maxBottom " + maxBottom +
                    " incrementalDeltaY " + incrementalDeltaY);
        }
        ...
        // isDown means scrolling up by ZZW
    ...
    private View fillDown(int itemPos, int nextTop) {
        if (DBG) Log.d(TAG, "fillDown - pos:" + itemPos + " nextTop:" + nextTop);
        ...
        while ((nextTop < end || hasSpaceDown()) && itemPos < mItemCount) {
