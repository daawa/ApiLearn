...
public class StaggeredGridView extends ExtendableListView {
    ...
    private void setPositionHeightRatio(final int itemPos, final int height) {
        GridItemRecord rec = getOrCreateRecord(itemPos);
        rec.heightRatio = (double)  height / (double) mColumnWidth;
        if (DBG) Log.d(TAG, "position:" + itemPos +
                            " width:" + mColumnWidth +
                            " height:" + height +
    ...
    private int getLowestColumnTop() {
