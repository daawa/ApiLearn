...
public class MoreFeaturedCameraActivity extends Activity {

	public static final String LOG_TAG = "MoreFeaturedCameraActivity";
...
//		Log.w(LOG_TAG, "MoreFeaturedCameraActivity onResume");
...
//	}
	...
	public void onCreate(Bundle saved) {
		Log.w(LOG_TAG, "MoreFeaturedCameraActivity onCreate");
				 ...
				 */
					...
					if (isRecording) {
						...
						if (prepareVideoRecorder()) {
							...
							releaseMediaRecorder();
							Toast.makeText(MoreFeaturedCameraActivity.this, "preparing didn't work", Toast.LENGTH_LONG)
									.show();
						}
					}
				}
